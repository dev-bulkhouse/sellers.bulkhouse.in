...
//    status's
    ...
    public function status_update($firm_type, $compid) {
        ...
        foreach ($result as $st) {
            ...
            if ($firm_type == 'partnership') {
                ...
                } elseif (  $photoid == 0 || $vat_cst_status == 0 || $pan_comp_status == 0 || $part_deed_status == 0  ) {
                    return "Waiting for Approved";
                } elseif (  $photoid == 2 || $vat_cst_status == 2 || $pan_comp_status == 2 || $part_deed_status == 2 ) {
                    return "Approved";
                } elseif ( $photoid == 1 || $vat_cst_status == 1 || $pan_comp_status == 1 || $part_deed_status == 1 ) {
                    return "Disapproved";
                }
            } elseif ($firm_type == 'proprietorship') {
                if ( $photoid == 5 || $vat_cst_status == 5 || $pan_prop_status == 5 ) {
                    return "Need To Upload";
                } elseif ( $photoid == 0 || $vat_cst_status == 0 || $pan_prop_status == 0 ) {
                    return "Waiting for Approved";
                } elseif ( $photoid == 2 || $vat_cst_status == 2 || $pan_prop_status == 2 ) {
                    return "Approved";
                } elseif ( $photoid == 1 || $vat_cst_status == 1 || $pan_prop_status == 1 ) {
                    return "Disapproved";
                }
            } elseif ($firm_type == 'pvt_or_ltd') {

                if ( $photoid == 5 || $vat_cst_status == 5 || $pan_comp_status == 5 ||  $moa_aoa_status == 5 ) {
                    return "Need To Upload";
                } elseif ( $photoid == 0 || $vat_cst_status == 0 || $pan_comp_status == 0 ||  $moa_aoa_status == 0 ) {
                    return "Waiting for Approved";
                } elseif ( $photoid == 2 || $vat_cst_status == 2 || $pan_comp_status == 2 ||  $moa_aoa_status == 2 ) {
                    return "Approved";
                } elseif ( $photoid == 1 || $vat_cst_status == 1 || $pan_comp_status == 1 ||  $moa_aoa_status == 1 ) {
                    return "Disapproved";
                }
            }
        }
    ...
    public function status_profile($compid) {
        ...
        foreach ($result as $st) {
            ...
            if ($address1 == "" || $address2 == "" || $city == "" || $state == "" || $pincode == "" || $contact_name == "" || $mobile_contact == "" || $email_contact == "" || $year_establishment == "" || $reg_category == "" || $tax_reg == "" || $cert_products == "") {
                return "Need To Submit";
            }
        }
    }
    ...
    public function redirect($compid) {
        ...
        if ($pan_prop_status == 2 && $vat_cst_status == 2   && $photoid_status == 2 && $canceled_check_status == 2) {
          ...
          if ($vat_cst_status == 2 && $pan_comp_status == 2 && $part_deed_status == 2   && $photoid_status == 2 && $canceled_check_status == 2) {
          ...
          if ($photoid_status == 2 && $vat_cst_status == 2 && $pan_comp_status == 2 &&  $moa_aoa_status == 2  && $canceled_check_status == 2) {
