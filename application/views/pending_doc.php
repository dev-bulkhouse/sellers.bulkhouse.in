...
<html lang="en">
    <head>
        <meta charset="utf-8">
         <title>Pending | Vendor Documents</title>
            ...
            <section class="scrollable wrapper animated fadeInDown"  >
                ...
                <div class="row" style="margin-bottom: 10px; padding: 10px;">
                    ...
                    <div class="col-lg-8 centered col-lg-offset-2">
                        ...
                        $data['doc_note'] = 'Please Upload Canceled Cheque here.<p style="font-size:0.8em">Note: Only JPG and PDF files allowed</p>';
                                ...
                                <div>
                                    ...
                                    <div class="list-group bg-white" style="background-color: whitesmoke">
                                        ...
                                        <a href="#" class="list-group-item">
                                            ...
                                            ?>
                                            <i class="icon-credit-card"></i> Canceled Cheque
