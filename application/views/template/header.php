...
<html class="no-js" lang="en" ng-app="myApp">
  <head>
    ...
    <link rel="stylesheet" href="http://bulkhouse.in/assets/css/foundation.css" />
    <script src="https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.4.4/angular.min.js"></script>

    <link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:400,700' rel='stylesheet' type='text/css'>
    <link href="http://bulkhouse.in/assets/css/added.css" rel="stylesheet" type="text/css"/>

    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    <script src="http://bulkhouse.in/assets/js/vendor/modernizr.js"></script>
    <script src="http://bulkhouse.in/assets/js/typed.js" type="text/javascript"></script>
