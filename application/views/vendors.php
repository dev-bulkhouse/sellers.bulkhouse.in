        ...
        <section>
            <div class="row m-n animated fadeInDown">
                <div class="col-md-12 col-lg-4 col-md-offset-4  m-t-lg">
                    <section class="panel">
                        <header class="panel-heading bg bg-primary text-center"> Add Vendors</header>
                        <form action="/view/add_vendor" method="POST" class="panel-body">
                            <div class="form-group">
                                <label class="control-label">Vendor ID</label>
                                <input type="number" name="custid" placeholder="Enter Vendor ID" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Vendor email</label>
                                <input type="email" name="email" placeholder="Enter Vendor Email" class="form-control" required>
                            </div>
        ...
        <section>
            ...
            <div class="row m-n animated fadeInDown">
                <div class="col-lg-6 centered col-lg-offset-3">
                    <section class="panel">
                        <header class="panel-heading bg bg-primary text-center"> Edit Vendor</header>
                        <div class="panel-body">
                            <table class="table datatable table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $result = $this->register_model->viewvendors();
