    ...
    <body class="page-container-boxed">
        ...
        <div class="container">
            ...
            <div class="row" style="border-bottom:0;">
                ...
                <button style="margin-left:50px" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#canceled_check" ><a href="/view/profile_step">Edit</a></button>
                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="number" pattern="[0-9]*" name ="account_number" class="form-control" required="required" value="<?php echo $row->account_number; ?>"/>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name ="bank_name" class="form-control" required="required" value="<?php echo $row->bank_name; ?>"/>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name ="branch" class="form-control" required="required" value="<?php echo $row->branch; ?>"/>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name ="ifsc" class="form-control" required="required" value="<?php echo $row->ifsc; ?>"/>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                            <input type="text" name ="micr" class="form-control" required="required" value="<?php echo $row->micr; } ?>"/>
                                                    </div>
