 ...
 <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea type="text"  placeholder="Address line 1" value="<?php
                                                echo $row->address1;
                                                ?>" name ="address1" class="bg-focus form-control" required="required"></textarea>
                                                    <div class="line line-dashed m-t-lg"></div>
                                                </div>

                                                <div class="col-sm-12">
                                                    <label>Address Line 2:</label>
                                                    <textarea type="text"  placeholder="Address line 2" value="<?php
                                                echo $row->address2;
                                                ?>" name ="address2" class="bg-focus form-control"></textarea>
                                                    <div class="line line-dashed m-t-lg"></div>
                                                </div>
                                                <div class="col-sm-12">
                                       ...
                                       <div class="pull-right col-lg-5 col-md-5 col-sm-5">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                ?>" name ="dispat_address1" class="bg-focus form-control" required="required"></textarea>
                                                <div class="line line-dashed m-t-lg"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                ?>" name ="dispat_address2" class="bg-focus form-control"></textarea>
                                                <div class="line line-dashed m-t-lg"></div>
                                            </div>
                                            <div class="col-sm-12">
                                                <label class="control-label">City:</label>
