...
<html lang="en">
    <head>
        ...
        <script>
            ...
            })(window, document, 'script', '_route', '//www.routecdn.com/tracker/route-tracker-min.js', '55dc6f3fab3e3c45a4cfec32');
        </script>
...
<!-- Modal -->
                <div id="offerModal" class="modal fade" role="dialog" style="z-index: 9999">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="small-6 columns zeropadding">
                                                        <div class="row">
                                                            ...
                                                            <input name="firstname" type="text"  id="firstname" placeholder="Firstname" required="required">
                                        <!--                    <small class="error">Vendor Name is required.</small>-->
                                                    ...
                                                    <div class="small-6 columns zeropadding">
                                                        <div class="row">
                                                            ...
                                                            <input name="lastname" type="text"  id="lastname" placeholder="Lastname" required="required">
                                        <!--                    <small class="error">Vendor Name is required.</small>-->
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="small-6 columns zeropadding">
                                                        <div class="row">
                                                            ...
                                                            <input name="password" type="password" pattern=".{6,10}" id="password"  placeholder="Please enter Password" required title="Minimum 6 characters required">
                                                ...
                                                <div class="row">
                                                    <div class="small-6 columns zeropadding">
                                                        <div class="row">
                                                            ...
                                                            <input name="mobile" type="number"  id="mobile" pattern="^[7-9][0-9]{9}$" placeholder="Please enter your Mobile number" required>
                                <!--<small class="error">Please Enter Password.</small>-->
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="small-6 columns zeropadding">
                                                        <div class="row">
                                                            ...
                                                            <input name="agent" type="text"  id="agent"  placeholder="Please enter Agent ID" >
                                                            <!--<small class="error">Please Enter Password.</small>-->
                                                        </div>
                                                    </div>
                                                    <div class="small-6 columns  zeropadding">
                                                        <div class="row">
                                                            ...
                                                            <input name="city" type="text"  id="city"  placeholder="Please enter City" ><!--
                                        <!--                    <small class="error">Please Repeat Password.</small>-->
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div id="Domestic" style="display: none">
                                <form  id="form_reg2" action="http://yesdesigns.in/register/register_user" method="post">
                                    <div class="row" style="padding-top: 20px">
                                        <div class="row">
                                            <div class="small-9 columns small-centered zeropadding">
                                                <div class="row">
                            ...
                            <div id="Both" style="display: none">
                                <form  id="form_reg3" action="http://yesdesigns.in/register/register_user" method="post">
                                    <div class="row" style="padding-top: 20px">
                                        <div class="row">
                                            <div class="small-9 columns small-centered zeropadding">
                                                <div class="row">
                                ...
                                <!--<small class="error">Please Enter Password.</small>-->
                                        ...
                                        <div class="row">
                                            <div class="large-10 columns small-centered zeropadding">
