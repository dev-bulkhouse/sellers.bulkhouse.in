        ...
        <section>
            <div class="row m-n animated fadeInDown">
                <div class="col-lg-8 centered col-lg-offset-2">
                    <section class="panel">
                        <header class="panel-heading bg bg-primary text-center"> Edit Agent</header>
                        <div class="panel-body">
                            <table class="table datatable">
                                ...
                                <td><a href='" . site_url('admin/edit_lead/' . $row->id) . "'>Edit</a> | <a href='" . site_url('admin/delete_lead/' . $row->id) . "'>Delete</a></td>
								</tr>";
                                    }
                                    ?>
                                </tbody>
