                ...
                <div class="page-content-wrap">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <ul class="panel-controls">
                                        ...
                                        <li> <?php $this->load->view('alert/success-message'); ?></li>
                                    </ul>
                                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-info active" href="<?php echo site_url()?>admin/profile/<?php echo $vendor->id; ?>">view</a> <a class="btn btn-danger active" href= "<?php echo site_url()?>register/delete/<?php echo $vendor->email ?>">Delete</a></td>
