...
<?php if (isset($bank1)) { ?>
<td>Account Name: <b><?php echo $bank1; ?></b><br>Account Number: <b><?php echo $bank2; ?></b><br>Bank Name: <b><?php echo $bank3; ?></b><br>Branch: <b><?php echo $bank4; ?></b><br>IFSC : <b><?php echo $bank5; ?></b><br>MICR: <b><?php echo $bank6; ?></b></td>
                        </small></h3>
...
if ($pan_prop_type == $filejpg || $pan_prop_type == $filejpg_a || $pan_prop_type == $filejpeg || $pan_prop_type == $filejpeg_a) {
    ?>
        <div class="modal-body">
