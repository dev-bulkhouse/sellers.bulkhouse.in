...
class Welcome extends CI_Controller {
	...
	function index()
	{
		...
		if (!$this->Users->table_exists()){
			$this->load->view('aws/no_table', $data);
		} else {
			...
			$this->load->view('aws/welcome', $data);
		}
	}
	...
	function add()
	{
		...
		$this->load->view('aws/add', $data); // Load the form
	}
	...
	function edit($memberid=0)
	{
		...
		$this->load->view('aws/edit', $data); // Load the form
	}
