(function($) {
    ...
    $.extend(FORM, {
        ...
        _show: function() {
            FORM.current_fs = $($('#'+FORM.opts['container']).find('.fieldset')[0]);
        ...
        _next: function() {
            ...
            $("#multistepform-progressbar li").eq($(".fieldset").index(FORM.next_fs)).addClass("active");
            ...
            FORM.current_fs.animate({opacity: 0}, {
                ...
                complete: function(){
                    ...
                    var curent_forms = FORM.current_fs.find('fieldset');
        ...
        next: function(){
            ...
            var form = $(FORM.current_fs).children('fieldset');
            if(form.length) {       
        ...
        prev: function() {
	        ...
	        $("#multistepform-progressbar li").eq($(".fieldset").index(FORM.current_fs)).removeClass("active");
